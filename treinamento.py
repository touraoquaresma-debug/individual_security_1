...
def train_yolov8_pose_model(
    ...
    with console.status('[bold green]Inicializando treinamento...'):
        console.print(
            Panel.fit(
        ...
        try:
            ...
            with Progress(
                ...
                results = model.train(
                    data=data_yaml_path, epochs=epochs, imgsz=imgsz
                )
    ...
    if train_results:
        ...
        console.print(
            Panel(
                ...
                + " 'predict.py' ou a função 'model.predict()'[/blue]\n"
